"""
Django settings for miHuerta project.
...
SECRET_KEY = '%b8d*jb5fk60bu4*flo23nuz=wz@qqjw(d+1m169$!s#au5$jm'
...
INSTALLED_APPS = [
    ...
    'miHuertaSite.apps.MihuertasiteConfig',
...
WSGI_APPLICATION = 'miHuerta.wsgi.application'
